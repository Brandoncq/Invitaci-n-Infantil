...
export const ModalGiftCollection = ({
  fontDescription,
  isVisible,
  onClose,
  name,
  ...
  accountData,
  locationData,
}: ModalGiftCollectionProps) => {
  return (
    <Column
      mainAxisAlignment="center"
      crossAxisAlignment="center"
      className={`fixed top-0 max-lg:px-4 left-0 w-full h-screen bg-[#fdfcf44a] gap-4 ${
        isVisible ? "z-10" : "-z-10 hidden"
    ...
    >
      ...
      >
        ...
        {name && (
          <h2 className="text-xl lg:text-2xl w-full text-center font-semibold">
            {name}
          </h2>
        )}
        {icon}
