...
export const Countdown = ({ fontDescription, fontSecondary, yearFinal, monthFinal, dayFinal, hourFinal = 0, minuteFinal = 0, secondFinal = 0 }: CountdownProps) => {
	...
	useEffect(() => {
		const finalDate = new Date(yearFinal, monthFinal - 1, dayFinal, hourFinal, minuteFinal, secondFinal);
	...
	return (
		...
		>
			<p className="text-3xl lg:text-4xl text-[#000000] -m-2 font-semibold">faltan</p>
			<div className={`flex gap-1 lg:gap-2 lg:p-5 text-3xl md:text-3xl p-3 rounded-lg ${fontDescription} text-blackGray`}>
