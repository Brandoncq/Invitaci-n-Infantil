...
export const DressCode = ({
	...
	return (
		<Column
			...
			className={`${window.innerWidth < 1024 && "assistance-assistance "} celebration py-8 lg:py-12 gap-3 lg:gap-5 w-full text-center`}
			data-aos="fade-up"
			data-aos-duration="1500"
		>
			<DressIcon className="h-[70px] lg:h-[80px]" />
			<h2 className={`retro-signature-custom text-2xl lg:text-4xl -mb-2 font-semibold ${fontTitle}`}>{dressLabel}</h2>
			<Column
				mainAxisAlignment="center"
				crossAxisAlignment="center"
				...
				<Row className="px-5 gap-3 w-full mt-5">
					...
					>
						<Column crossAxisAlignment="center">
							<p className="text-sm lg:text-base uppercase font-semibold">{femaleLabel}</p>
							<p className="text-sm lg:text-base uppercase font-semibold">{femaleDressType}</p>
						</Column>
						{femaleIcon}
					...
					>
						<Column crossAxisAlignment="center">
							<p className="text-sm lg:text-base uppercase font-semibold">{maleLabel}</p>
							<p className="text-sm lg:text-base uppercase font-semibold">{maleDressType}</p>
						</Column>
						{maleIcon}
